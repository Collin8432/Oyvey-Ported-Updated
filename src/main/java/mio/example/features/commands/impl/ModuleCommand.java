...
import mio.example.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Mio.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : Mio.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Mio.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Mio.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
