...
public class MioGui extends Screen {
    private static MioGui MioGui;
    private static MioGui INSTANCE;
    ...
    public static MioGui getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new MioGui();
        }
        return INSTANCE;
    ...
    public static MioGui getClickGui() {
        return MioGui.getInstance();
    }
