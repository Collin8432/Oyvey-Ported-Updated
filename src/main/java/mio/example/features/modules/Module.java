package mio.example.features.modules;

import com.google.gson.JsonElement;
import com.google.gson.JsonObject;
import mio.example.Mio;
import mio.example.event.impl.ClientEvent;
...
public class Module extends Feature implements Jsonable {
    ...
    public void setDisplayName(String name) {
        Module module = Mio.moduleManager.getModuleByDisplayName(name);
        Module originalModule = Mio.moduleManager.getModuleByName(name);
