...
import static mio.example.util.render.Renderer3d.getColor;
import static mio.example.util.render.RendererUtils.endRender;
import static mio.example.util.render.RendererUtils.setupRender;
